...
public class healhub extends Application {
    @Override
    public void start(Stage primaryStage) {
        ...
        // Load the image
        Image callImage = new Image("Images/piggy.png"); 
        ...
        topPane.getChildren().addAll(notificationsButton, selectPatientComboBox, nameLabel, nameField, emailLabel, emailField, phoneLabel, phoneField, addressLabel, callLabel, callButton, callImageView, addressField, doctorNameLabel);
